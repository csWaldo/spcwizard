...
Each rule represents a set of combineable model and contains:
...
peers | list of models that can combine with each other
qc path | path to the stub qc used to compile the combined model
